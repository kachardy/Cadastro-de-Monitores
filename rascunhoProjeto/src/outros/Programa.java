...
public class Programa {
	...
	public static void main(String[] args) {
		...
		if (central == null) {
		    System.out.println("Nenhum arquivo encontrado. Criando nova central...");
		    central = new CentralDeInformacoes();
		} else {
		    // Segurança extra — caso o XML não tenha listas
		    if (central.getTodosOsEditais() == null)
		        central.setTodosOsEditais(new ArrayList<EditalDeMonitoria>());

		    if (central.getTodosOsAlunos() == null)
		        central.setTodosOsAlunos(new ArrayList<Aluno> ());
		}
